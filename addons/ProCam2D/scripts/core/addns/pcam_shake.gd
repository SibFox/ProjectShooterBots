...
# Exported properties
@export var preset: Preset = Preset.CUSTOM: set = set_preset
@export var speed = 15.0 # (float, 0, 100)
@export var intensity = 10.0 # (float, 0, 100)
@export var shake_type = 0 # (int, FLAGS, "Vertical", "Horizontal", "Random", "Perlin", "Rotate", "Circular", "Zoom")
@export var trauma_attack = 0.0  # New parameter for fade-in # (float, 0, 10)
@export var trauma_decay = 0.8 # (float, 0, 10)
@export var duration = 0.5 # (float, 0, 10)
